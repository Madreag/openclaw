---
source: https://docs.molt.bot/platforms/mac/icon
title: Icon - Moltbot
---

[Skip to main content](https://docs.molt.bot/platforms/mac/icon#content-area)
...
- [Menu Bar Icon States](https://docs.molt.bot/platforms/mac/icon#menu-bar-icon-states)

# [​](https://docs.molt.bot/platforms/mac/icon\#menu-bar-icon-states)  Menu Bar Icon States
...
[Health](https://docs.molt.bot/platforms/mac/health) [Logging](https://docs.molt.bot/platforms/mac/logging)
