...
title: Matrix - Moltbot
---

[Skip to main content](https://docs.molt.bot/channels/matrix#content-area)
...
- [Matrix (plugin)](https://docs.molt.bot/channels/matrix#matrix-plugin)
- [Plugin required](https://docs.molt.bot/channels/matrix#plugin-required)
- [Setup](https://docs.molt.bot/channels/matrix#setup)
- [Encryption (E2EE)](https://docs.molt.bot/channels/matrix#encryption-e2ee)
- [Routing model](https://docs.molt.bot/channels/matrix#routing-model)
- [Access control (DMs)](https://docs.molt.bot/channels/matrix#access-control-dms)
- [Rooms (groups)](https://docs.molt.bot/channels/matrix#rooms-groups)
- [Threads](https://docs.molt.bot/channels/matrix#threads)
- [Capabilities](https://docs.molt.bot/channels/matrix#capabilities)
- [Configuration reference (Matrix)](https://docs.molt.bot/channels/matrix#configuration-reference-matrix)

# [​](https://docs.molt.bot/channels/matrix\#matrix-plugin)  Matrix (plugin)
...
## [​](https://docs.molt.bot/channels/matrix\#plugin-required)  Plugin required
...
## [​](https://docs.molt.bot/channels/matrix\#setup)  Setup

1. Install the Matrix plugin:   - From npm: `moltbot plugins install @moltbot/matrix`
...
## [​](https://docs.molt.bot/channels/matrix\#encryption-e2ee)  Encryption (E2EE)
...
## [​](https://docs.molt.bot/channels/matrix\#routing-model)  Routing model

- Replies always go back to Matrix.
- DMs share the agent’s main session; rooms map to group sessions.

## [​](https://docs.molt.bot/channels/matrix\#access-control-dms)  Access control (DMs)
...
## [​](https://docs.molt.bot/channels/matrix\#rooms-groups)  Rooms (groups)
...
## [​](https://docs.molt.bot/channels/matrix\#threads)  Threads
...
## [​](https://docs.molt.bot/channels/matrix\#capabilities)  Capabilities
...
## [​](https://docs.molt.bot/channels/matrix\#configuration-reference-matrix)  Configuration reference (Matrix)
...
[Line](https://docs.molt.bot/channels/line) [Zalo](https://docs.molt.bot/channels/zalo)
