---
source: https://docs.molt.bot/channels/slack
title: Slack - Moltbot
---

[Skip to main content](https://docs.molt.bot/channels/slack#content-area)
...
- [Slack](https://docs.molt.bot/channels/slack#slack)
- [Socket mode (default)](https://docs.molt.bot/channels/slack#socket-mode-default)
- [Quick setup (beginner)](https://docs.molt.bot/channels/slack#quick-setup-beginner)
- [Setup](https://docs.molt.bot/channels/slack#setup)
- [Moltbot config (minimal)](https://docs.molt.bot/channels/slack#moltbot-config-minimal)
- [User token (optional)](https://docs.molt.bot/channels/slack#user-token-optional)
- [Token usage](https://docs.molt.bot/channels/slack#token-usage)
- [History context](https://docs.molt.bot/channels/slack#history-context)
- [HTTP mode (Events API)](https://docs.molt.bot/channels/slack#http-mode-events-api)
- [Setup](https://docs.molt.bot/channels/slack#setup-2)
- [Moltbot config (minimal)](https://docs.molt.bot/channels/slack#moltbot-config-minimal-2)
- [Manifest (optional)](https://docs.molt.bot/channels/slack#manifest-optional)
- [Scopes (current vs optional)](https://docs.molt.bot/channels/slack#scopes-current-vs-optional)
- [Bot token scopes (required)](https://docs.molt.bot/channels/slack#bot-token-scopes-required)
- [User token scopes (optional, read-only by default)](https://docs.molt.bot/channels/slack#user-token-scopes-optional%2C-read-only-by-default)
- [Not needed today (but likely future)](https://docs.molt.bot/channels/slack#not-needed-today-but-likely-future)
- [Config](https://docs.molt.bot/channels/slack#config)
- [Limits](https://docs.molt.bot/channels/slack#limits)
- [Reply threading](https://docs.molt.bot/channels/slack#reply-threading)
- [Per-chat-type threading](https://docs.molt.bot/channels/slack#per-chat-type-threading)
- [Manual threading tags](https://docs.molt.bot/channels/slack#manual-threading-tags)
- [Sessions + routing](https://docs.molt.bot/channels/slack#sessions-%2B-routing)
- [DM security (pairing)](https://docs.molt.bot/channels/slack#dm-security-pairing)
- [Group policy](https://docs.molt.bot/channels/slack#group-policy)
- [Delivery targets](https://docs.molt.bot/channels/slack#delivery-targets)
- [Tool actions](https://docs.molt.bot/channels/slack#tool-actions)
- [Security notes](https://docs.molt.bot/channels/slack#security-notes)
- [Notes](https://docs.molt.bot/channels/slack#notes)

# [​](https://docs.molt.bot/channels/slack\#slack)  Slack

## [​](https://docs.molt.bot/channels/slack\#socket-mode-default)  Socket mode (default)

### [​](https://docs.molt.bot/channels/slack\#quick-setup-beginner)  Quick setup (beginner)
...
### [​](https://docs.molt.bot/channels/slack\#setup)  Setup
...
### [​](https://docs.molt.bot/channels/slack\#moltbot-config-minimal)  Moltbot config (minimal)
...
### [​](https://docs.molt.bot/channels/slack\#user-token-optional)  User token (optional)
...
#### [​](https://docs.molt.bot/channels/slack\#token-usage)  Token usage
...
### [​](https://docs.molt.bot/channels/slack\#history-context)  History context

- `channels.slack.historyLimit` (or `channels.slack.accounts.*.historyLimit`) controls how many recent channel/group messages are wrapped into the prompt.
- Falls back to `messages.groupChat.historyLimit`. Set `0` to disable (default 50).

## [​](https://docs.molt.bot/channels/slack\#http-mode-events-api)  HTTP mode (Events API)
...
### [​](https://docs.molt.bot/channels/slack\#setup-2)  Setup
...
### [​](https://docs.molt.bot/channels/slack\#moltbot-config-minimal-2)  Moltbot config (minimal)
...
### [​](https://docs.molt.bot/channels/slack\#manifest-optional)  Manifest (optional)
...
## [​](https://docs.molt.bot/channels/slack\#scopes-current-vs-optional)  Scopes (current vs optional)
...
### [​](https://docs.molt.bot/channels/slack\#bot-token-scopes-required)  Bot token scopes (required)
...
### [​](https://docs.molt.bot/channels/slack\#user-token-scopes-optional,-read-only-by-default)  User token scopes (optional, read-only by default)
...
### [​](https://docs.molt.bot/channels/slack\#not-needed-today-but-likely-future)  Not needed today (but likely future)
...
## [​](https://docs.molt.bot/channels/slack\#config)  Config
...
## [​](https://docs.molt.bot/channels/slack\#limits)  Limits
...
## [​](https://docs.molt.bot/channels/slack\#reply-threading)  Reply threading
...
### [​](https://docs.molt.bot/channels/slack\#per-chat-type-threading)  Per-chat-type threading
...
### [​](https://docs.molt.bot/channels/slack\#manual-threading-tags)  Manual threading tags
...
## [​](https://docs.molt.bot/channels/slack\#sessions-+-routing)  Sessions + routing
...
## [​](https://docs.molt.bot/channels/slack\#dm-security-pairing)  DM security (pairing)
...
## [​](https://docs.molt.bot/channels/slack\#group-policy)  Group policy
...
## [​](https://docs.molt.bot/channels/slack\#delivery-targets)  Delivery targets
...
## [​](https://docs.molt.bot/channels/slack\#tool-actions)  Tool actions
...
## [​](https://docs.molt.bot/channels/slack\#security-notes)  Security notes
...
## [​](https://docs.molt.bot/channels/slack\#notes)  Notes
...
- For the Slack tool, reaction removal semantics are in [/tools/reactions](https://docs.molt.bot/tools/reactions).
- Attachments are downloaded to the media store when permitted and under the size limit.

[Discord](https://docs.molt.bot/channels/discord) [Googlechat](https://docs.molt.bot/channels/googlechat)
