---
source: https://docs.molt.bot/channels/discord
title: Discord - Moltbot
---

[Skip to main content](https://docs.molt.bot/channels/discord#content-area)
...
- [Discord (Bot API)](https://docs.molt.bot/channels/discord#discord-bot-api)
- [Quick setup (beginner)](https://docs.molt.bot/channels/discord#quick-setup-beginner)
- [Goals](https://docs.molt.bot/channels/discord#goals)
- [How it works](https://docs.molt.bot/channels/discord#how-it-works)
- [Config writes](https://docs.molt.bot/channels/discord#config-writes)
- [How to create your own bot](https://docs.molt.bot/channels/discord#how-to-create-your-own-bot)
- [1) Create the Discord app + bot user](https://docs.molt.bot/channels/discord#1-create-the-discord-app-%2B-bot-user)
- [2) Enable the gateway intents Moltbot needs](https://docs.molt.bot/channels/discord#2-enable-the-gateway-intents-moltbot-needs)
- [3) Generate an invite URL (OAuth2 URL Generator)](https://docs.molt.bot/channels/discord#3-generate-an-invite-url-oauth2-url-generator)
- [4) Get the ids (guild/user/channel)](https://docs.molt.bot/channels/discord#4-get-the-ids-guild%2Fuser%2Fchannel)
- [5) Configure Moltbot](https://docs.molt.bot/channels/discord#5-configure-moltbot)
- [Token](https://docs.molt.bot/channels/discord#token)
- [Allowlist + channel routing](https://docs.molt.bot/channels/discord#allowlist-%2B-channel-routing)
- [6) Verify it works](https://docs.molt.bot/channels/discord#6-verify-it-works)
- [Troubleshooting](https://docs.molt.bot/channels/discord#troubleshooting)
- [Capabilities & limits](https://docs.molt.bot/channels/discord#capabilities-%26-limits)
- [Retry policy](https://docs.molt.bot/channels/discord#retry-policy)
- [Config](https://docs.molt.bot/channels/discord#config)
- [Tool action defaults](https://docs.molt.bot/channels/discord#tool-action-defaults)
- [Reply tags](https://docs.molt.bot/channels/discord#reply-tags)
- [Tool actions](https://docs.molt.bot/channels/discord#tool-actions)
- [Safety & ops](https://docs.molt.bot/channels/discord#safety-%26-ops)

# [​](https://docs.molt.bot/channels/discord\#discord-bot-api)  Discord (Bot API)

Status: ready for DM and guild text channels via the official Discord bot gateway.

## [​](https://docs.molt.bot/channels/discord\#quick-setup-beginner)  Quick setup (beginner)
...
## [​](https://docs.molt.bot/channels/discord\#goals)  Goals
...
## [​](https://docs.molt.bot/channels/discord\#how-it-works)  How it works
...
03. Configure Moltbot with `channels.discord.token` (or `DISCORD_BOT_TOKEN` as a fallback).
...
07. Direct chats: secure by default via `channels.discord.dm.policy` (default: `"pairing"`). Unknown senders get a pairing code (expires after 1 hour); approve via `moltbot pairing approve discord <code>`.
...
10. Optional native commands: `commands.native` defaults to `"auto"` (on for Discord/Telegram, off for Slack). Override with `channels.discord.commands.native: true|false|"auto"`; `false` clears previously registered commands. Text commands are controlled by `commands.text` and must be sent as standalone `/...` messages. Use `commands.useAccessGroups: false` to bypass access-group checks for commands.
    ...
    - Full command list + config: [Slash commands](https://docs.molt.bot/tools/slash-commands)
...
## [​](https://docs.molt.bot/channels/discord\#config-writes)  Config writes
...
## [​](https://docs.molt.bot/channels/discord\#how-to-create-your-own-bot)  How to create your own bot

This is the “Discord Developer Portal” setup for running Moltbot in a server (guild) channel like `#help`.

### [​](https://docs.molt.bot/channels/discord\#1-create-the-discord-app-+-bot-user)  1) Create the Discord app + bot user
...
### [​](https://docs.molt.bot/channels/discord\#2-enable-the-gateway-intents-moltbot-needs)  2) Enable the gateway intents Moltbot needs
...
### [​](https://docs.molt.bot/channels/discord\#3-generate-an-invite-url-oauth2-url-generator)  3) Generate an invite URL (OAuth2 URL Generator)
...
### [​](https://docs.molt.bot/channels/discord\#4-get-the-ids-guild/user/channel)  4) Get the ids (guild/user/channel)
...
### [​](https://docs.molt.bot/channels/discord\#5-configure-moltbot)  5) Configure Moltbot

#### [​](https://docs.molt.bot/channels/discord\#token)  Token
...
Multi-account support: use `channels.discord.accounts` with per-account tokens and optional `name`. See [`gateway/configuration`](https://docs.molt.bot/gateway/configuration#telegramaccounts--discordaccounts--slackaccounts--signalaccounts--imessageaccounts) for the shared pattern.

#### [​](https://docs.molt.bot/channels/discord\#allowlist-+-channel-routing)  Allowlist + channel routing
...
### [​](https://docs.molt.bot/channels/discord\#6-verify-it-works)  6) Verify it works

1. Start the gateway.
2. In your server channel, send: `@Krill hello` (or whatever your bot name is).
3. If nothing happens: check **Troubleshooting** below.

### [​](https://docs.molt.bot/channels/discord\#troubleshooting)  Troubleshooting
...
## [​](https://docs.molt.bot/channels/discord\#capabilities-&-limits)  Capabilities & limits
...
## [​](https://docs.molt.bot/channels/discord\#retry-policy)  Retry policy

Outbound Discord API calls retry on rate limits (429) using Discord `retry_after` when available, with exponential backoff and jitter. Configure via `channels.discord.retry`. See [Retry policy](https://docs.molt.bot/concepts/retry).

## [​](https://docs.molt.bot/channels/discord\#config)  Config
...
### [​](https://docs.molt.bot/channels/discord\#tool-action-defaults)  Tool action defaults
...
## [​](https://docs.molt.bot/channels/discord\#reply-tags)  Reply tags
...
## [​](https://docs.molt.bot/channels/discord\#tool-actions)  Tool actions
...
## [​](https://docs.molt.bot/channels/discord\#safety-&-ops)  Safety & ops
...
[Grammy](https://docs.molt.bot/channels/grammy) [Slack](https://docs.molt.bot/channels/slack)
