...
title: Configuration - Moltbot
---

[Skip to main content](https://docs.molt.bot/gateway/configuration#content-area)
...
- [Configuration 🔧](https://docs.molt.bot/gateway/configuration#configuration-%F0%9F%94%A7)
- [Strict config validation](https://docs.molt.bot/gateway/configuration#strict-config-validation)
- [Schema + UI hints](https://docs.molt.bot/gateway/configuration#schema-%2B-ui-hints)
- [Apply + restart (RPC)](https://docs.molt.bot/gateway/configuration#apply-%2B-restart-rpc)
- [Partial updates (RPC)](https://docs.molt.bot/gateway/configuration#partial-updates-rpc)
- [Minimal config (recommended starting point)](https://docs.molt.bot/gateway/configuration#minimal-config-recommended-starting-point)
- [Self-chat mode (recommended for group control)](https://docs.molt.bot/gateway/configuration#self-chat-mode-recommended-for-group-control)
- [Config Includes ($include)](https://docs.molt.bot/gateway/configuration#config-includes-%24include)
- [Basic usage](https://docs.molt.bot/gateway/configuration#basic-usage)
- [Merge behavior](https://docs.molt.bot/gateway/configuration#merge-behavior)
- [Nested includes](https://docs.molt.bot/gateway/configuration#nested-includes)
- [Path resolution](https://docs.molt.bot/gateway/configuration#path-resolution)
- [Error handling](https://docs.molt.bot/gateway/configuration#error-handling)
- [Example: Multi-client legal setup](https://docs.molt.bot/gateway/configuration#example%3A-multi-client-legal-setup)
- [Common options](https://docs.molt.bot/gateway/configuration#common-options)
- [Env vars + .env](https://docs.molt.bot/gateway/configuration#env-vars-%2B-env)
- [env.shellEnv (optional)](https://docs.molt.bot/gateway/configuration#env-shellenv-optional)
- [Env var substitution in config](https://docs.molt.bot/gateway/configuration#env-var-substitution-in-config)
- [Auth storage (OAuth + API keys)](https://docs.molt.bot/gateway/configuration#auth-storage-oauth-%2B-api-keys)
- [auth](https://docs.molt.bot/gateway/configuration#auth)
- [agents.list\[\].identity](https://docs.molt.bot/gateway/configuration#agents-list%5B%5D-identity)
- [wizard](https://docs.molt.bot/gateway/configuration#wizard)
- [logging](https://docs.molt.bot/gateway/configuration#logging)
- [channels.whatsapp.dmPolicy](https://docs.molt.bot/gateway/configuration#channels-whatsapp-dmpolicy)
- [channels.whatsapp.allowFrom](https://docs.molt.bot/gateway/configuration#channels-whatsapp-allowfrom)
- [channels.whatsapp.sendReadReceipts](https://docs.molt.bot/gateway/configuration#channels-whatsapp-sendreadreceipts)
- [channels.whatsapp.accounts (multi-account)](https://docs.molt.bot/gateway/configuration#channels-whatsapp-accounts-multi-account)
- [channels.telegram.accounts / channels.discord.accounts / channels.googlechat.accounts / channels.slack.accounts / channels.mattermost.accounts / channels.signal.accounts / channels.imessage.accounts](https://docs.molt.bot/gateway/configuration#channels-telegram-accounts-%2F-channels-discord-accounts-%2F-channels-googlechat-accounts-%2F-channels-slack-accounts-%2F-channels-mattermost-accounts-%2F-channels-signal-accounts-%2F-channels-imessage-accounts)
- [Group chat mention gating (agents.list\[\].groupChat + messages.groupChat)](https://docs.molt.bot/gateway/configuration#group-chat-mention-gating-agents-list%5B%5D-groupchat-%2B-messages-groupchat)
- [DM history limits](https://docs.molt.bot/gateway/configuration#dm-history-limits)
- [Group policy (per channel)](https://docs.molt.bot/gateway/configuration#group-policy-per-channel)
- [Multi-agent routing (agents.list + bindings)](https://docs.molt.bot/gateway/configuration#multi-agent-routing-agents-list-%2B-bindings)
- [Per-agent access profiles (multi-agent)](https://docs.molt.bot/gateway/configuration#per-agent-access-profiles-multi-agent)
- [tools.agentToAgent (optional)](https://docs.molt.bot/gateway/configuration#tools-agenttoagent-optional)
- [messages.queue](https://docs.molt.bot/gateway/configuration#messages-queue)
- [messages.inbound](https://docs.molt.bot/gateway/configuration#messages-inbound)
- [commands (chat command handling)](https://docs.molt.bot/gateway/configuration#commands-chat-command-handling)
- [web (WhatsApp web channel runtime)](https://docs.molt.bot/gateway/configuration#web-whatsapp-web-channel-runtime)
- [channels.telegram (bot transport)](https://docs.molt.bot/gateway/configuration#channels-telegram-bot-transport)
- [channels.discord (bot transport)](https://docs.molt.bot/gateway/configuration#channels-discord-bot-transport)
- [channels.googlechat (Chat API webhook)](https://docs.molt.bot/gateway/configuration#channels-googlechat-chat-api-webhook)
- [channels.slack (socket mode)](https://docs.molt.bot/gateway/configuration#channels-slack-socket-mode)
- [channels.mattermost (bot token)](https://docs.molt.bot/gateway/configuration#channels-mattermost-bot-token)
- [channels.signal (signal-cli)](https://docs.molt.bot/gateway/configuration#channels-signal-signal-cli)
- [channels.imessage (imsg CLI)](https://docs.molt.bot/gateway/configuration#channels-imessage-imsg-cli)
- [agents.defaults.workspace](https://docs.molt.bot/gateway/configuration#agents-defaults-workspace)
- [agents.defaults.repoRoot](https://docs.molt.bot/gateway/configuration#agents-defaults-reporoot)
- [agents.defaults.skipBootstrap](https://docs.molt.bot/gateway/configuration#agents-defaults-skipbootstrap)
- [agents.defaults.bootstrapMaxChars](https://docs.molt.bot/gateway/configuration#agents-defaults-bootstrapmaxchars)
- [agents.defaults.userTimezone](https://docs.molt.bot/gateway/configuration#agents-defaults-usertimezone)
- [agents.defaults.timeFormat](https://docs.molt.bot/gateway/configuration#agents-defaults-timeformat)
- [messages](https://docs.molt.bot/gateway/configuration#messages)
- [Template variables](https://docs.molt.bot/gateway/configuration#template-variables)
- [messages.tts](https://docs.molt.bot/gateway/configuration#messages-tts)
- [talk](https://docs.molt.bot/gateway/configuration#talk)
- [agents.defaults](https://docs.molt.bot/gateway/configuration#agents-defaults)
- [agents.defaults.cliBackends (CLI fallback)](https://docs.molt.bot/gateway/configuration#agents-defaults-clibackends-cli-fallback)
- [agents.defaults.contextPruning (tool-result pruning)](https://docs.molt.bot/gateway/configuration#agents-defaults-contextpruning-tool-result-pruning)
- [agents.defaults.compaction (reserve headroom + memory flush)](https://docs.molt.bot/gateway/configuration#agents-defaults-compaction-reserve-headroom-%2B-memory-flush)
- [agents.defaults.sandbox](https://docs.molt.bot/gateway/configuration#agents-defaults-sandbox)
- [models (custom providers + base URLs)](https://docs.molt.bot/gateway/configuration#models-custom-providers-%2B-base-urls)
- [OpenCode Zen (multi-model proxy)](https://docs.molt.bot/gateway/configuration#opencode-zen-multi-model-proxy)
- [Z.AI (GLM-4.7) — provider alias support](https://docs.molt.bot/gateway/configuration#z-ai-glm-4-7-%E2%80%94-provider-alias-support)
- [Moonshot AI (Kimi)](https://docs.molt.bot/gateway/configuration#moonshot-ai-kimi)
- [Kimi Code](https://docs.molt.bot/gateway/configuration#kimi-code)
- [Synthetic (Anthropic-compatible)](https://docs.molt.bot/gateway/configuration#synthetic-anthropic-compatible)
- [Local models (LM Studio) — recommended setup](https://docs.molt.bot/gateway/configuration#local-models-lm-studio-%E2%80%94-recommended-setup)
- [MiniMax M2.1](https://docs.molt.bot/gateway/configuration#minimax-m2-1)
- [Cerebras (GLM 4.6 / 4.7)](https://docs.molt.bot/gateway/configuration#cerebras-glm-4-6-%2F-4-7)
- [session](https://docs.molt.bot/gateway/configuration#session)
- [skills (skills config)](https://docs.molt.bot/gateway/configuration#skills-skills-config)
- [plugins (extensions)](https://docs.molt.bot/gateway/configuration#plugins-extensions)
- [browser (clawd-managed browser)](https://docs.molt.bot/gateway/configuration#browser-clawd-managed-browser)
- [ui (Appearance)](https://docs.molt.bot/gateway/configuration#ui-appearance)
- [gateway (Gateway server mode + bind)](https://docs.molt.bot/gateway/configuration#gateway-gateway-server-mode-%2B-bind)
- [gateway.reload (Config hot reload)](https://docs.molt.bot/gateway/configuration#gateway-reload-config-hot-reload)
- [Hot reload matrix (files + impact)](https://docs.molt.bot/gateway/configuration#hot-reload-matrix-files-%2B-impact)
- [Multi-instance isolation](https://docs.molt.bot/gateway/configuration#multi-instance-isolation)
- [hooks (Gateway webhooks)](https://docs.molt.bot/gateway/configuration#hooks-gateway-webhooks)
- [canvasHost (LAN/tailnet Canvas file server + live reload)](https://docs.molt.bot/gateway/configuration#canvashost-lan%2Ftailnet-canvas-file-server-%2B-live-reload)
- [bridge (legacy TCP bridge, removed)](https://docs.molt.bot/gateway/configuration#bridge-legacy-tcp-bridge%2C-removed)
- [discovery.mdns (Bonjour / mDNS broadcast mode)](https://docs.molt.bot/gateway/configuration#discovery-mdns-bonjour-%2F-mdns-broadcast-mode)
- [discovery.wideArea (Wide-Area Bonjour / unicast DNS‑SD)](https://docs.molt.bot/gateway/configuration#discovery-widearea-wide-area-bonjour-%2F-unicast-dns%E2%80%91sd)
- [Template variables](https://docs.molt.bot/gateway/configuration#template-variables-2)
- [Cron (Gateway scheduler)](https://docs.molt.bot/gateway/configuration#cron-gateway-scheduler)

# [​](https://docs.molt.bot/gateway/configuration\#configuration-%F0%9F%94%A7)  Configuration 🔧
...
> **New to configuration?** Check out the [Configuration Examples](https://docs.molt.bot/gateway/configuration-examples) guide for complete examples with detailed explanations!

## [​](https://docs.molt.bot/gateway/configuration\#strict-config-validation)  Strict config validation
...
## [​](https://docs.molt.bot/gateway/configuration\#schema-+-ui-hints)  Schema + UI hints
...
## [​](https://docs.molt.bot/gateway/configuration\#apply-+-restart-rpc)  Apply + restart (RPC)
...
use `config.patch` or `moltbot config set`. Keep a backup of `~/.clawdbot/moltbot.json`.Params:
...
## [​](https://docs.molt.bot/gateway/configuration\#partial-updates-rpc)  Partial updates (RPC)
...
## [​](https://docs.molt.bot/gateway/configuration\#minimal-config-recommended-starting-point)  Minimal config (recommended starting point)
...
## [​](https://docs.molt.bot/gateway/configuration\#self-chat-mode-recommended-for-group-control)  Self-chat mode (recommended for group control)
...
## [​](https://docs.molt.bot/gateway/configuration\#config-includes-$include)  Config Includes (`$include`)
...
### [​](https://docs.molt.bot/gateway/configuration\#basic-usage)  Basic usage
...
### [​](https://docs.molt.bot/gateway/configuration\#merge-behavior)  Merge behavior
...
### [​](https://docs.molt.bot/gateway/configuration\#nested-includes)  Nested includes
...
### [​](https://docs.molt.bot/gateway/configuration\#path-resolution)  Path resolution
...
### [​](https://docs.molt.bot/gateway/configuration\#error-handling)  Error handling
...
### [​](https://docs.molt.bot/gateway/configuration\#example:-multi-client-legal-setup)  Example: Multi-client legal setup
...
## [​](https://docs.molt.bot/gateway/configuration\#common-options)  Common options

### [​](https://docs.molt.bot/gateway/configuration\#env-vars-+-env)  Env vars + `.env`
...
See [/environment](https://docs.molt.bot/environment) for full precedence and sources.

### [​](https://docs.molt.bot/gateway/configuration\#env-shellenv-optional)  `env.shellEnv` (optional)
...
### [​](https://docs.molt.bot/gateway/configuration\#env-var-substitution-in-config)  Env var substitution in config
...
### [​](https://docs.molt.bot/gateway/configuration\#auth-storage-oauth-+-api-keys)  Auth storage (OAuth + API keys)
...
See also: [/concepts/oauth](https://docs.molt.bot/concepts/oauth)Legacy OAuth imports:
...
### [​](https://docs.molt.bot/gateway/configuration\#auth)  `auth`
...
### [​](https://docs.molt.bot/gateway/configuration\#agents-list[]-identity)  `agents.list[].identity`
...
### [​](https://docs.molt.bot/gateway/configuration\#wizard)  `wizard`
...
### [​](https://docs.molt.bot/gateway/configuration\#logging)  `logging`
...
### [​](https://docs.molt.bot/gateway/configuration\#channels-whatsapp-dmpolicy)  `channels.whatsapp.dmPolicy`
...
### [​](https://docs.molt.bot/gateway/configuration\#channels-whatsapp-allowfrom)  `channels.whatsapp.allowFrom`
...
### [​](https://docs.molt.bot/gateway/configuration\#channels-whatsapp-sendreadreceipts)  `channels.whatsapp.sendReadReceipts`
...
### [​](https://docs.molt.bot/gateway/configuration\#channels-whatsapp-accounts-multi-account)  `channels.whatsapp.accounts` (multi-account)
...
### [​](https://docs.molt.bot/gateway/configuration\#group-chat-mention-gating-agents-list[]-groupchat-+-messages-groupchat)  Group chat mention gating (`agents.list[].groupChat` \+ `messages.groupChat`)
...
#### [​](https://docs.molt.bot/gateway/configuration\#dm-history-limits)  DM history limits
...
### [​](https://docs.molt.bot/gateway/configuration\#group-policy-per-channel)  Group policy (per channel)
...
### [​](https://docs.molt.bot/gateway/configuration\#multi-agent-routing-agents-list-+-bindings)  Multi-agent routing (`agents.list` \+ `bindings`)
...
#### [​](https://docs.molt.bot/gateway/configuration\#per-agent-access-profiles-multi-agent)  Per-agent access profiles (multi-agent)
...
See [Multi-Agent Sandbox & Tools](https://docs.molt.bot/multi-agent-sandbox-tools) for precedence and
...
### [​](https://docs.molt.bot/gateway/configuration\#tools-agenttoagent-optional)  `tools.agentToAgent` (optional)
...
### [​](https://docs.molt.bot/gateway/configuration\#messages-queue)  `messages.queue`
...
### [​](https://docs.molt.bot/gateway/configuration\#messages-inbound)  `messages.inbound`
...
### [​](https://docs.molt.bot/gateway/configuration\#commands-chat-command-handling)  `commands` (chat command handling)
...
### [​](https://docs.molt.bot/gateway/configuration\#web-whatsapp-web-channel-runtime)  `web` (WhatsApp web channel runtime)
...
### [​](https://docs.molt.bot/gateway/configuration\#channels-telegram-bot-transport)  `channels.telegram` (bot transport)
...
Retry policy defaults and behavior are documented in [Retry policy](https://docs.molt.bot/concepts/retry).

### [​](https://docs.molt.bot/gateway/configuration\#channels-discord-bot-transport)  `channels.discord` (bot transport)
...
### [​](https://docs.molt.bot/gateway/configuration\#channels-googlechat-chat-api-webhook)  `channels.googlechat` (Chat API webhook)
...
### [​](https://docs.molt.bot/gateway/configuration\#channels-slack-socket-mode)  `channels.slack` (socket mode)
...
### [​](https://docs.molt.bot/gateway/configuration\#channels-mattermost-bot-token)  `channels.mattermost` (bot token)

Mattermost ships as a plugin and is not bundled with the core install.
Install it first: `moltbot plugins install @moltbot/mattermost` (or `./extensions/mattermost` from a git checkout).Mattermost requires a bot token plus the base URL for your server:
...
### [​](https://docs.molt.bot/gateway/configuration\#channels-signal-signal-cli)  `channels.signal` (signal-cli)
...
### [​](https://docs.molt.bot/gateway/configuration\#channels-imessage-imsg-cli)  `channels.imessage` (imsg CLI)
...
### [​](https://docs.molt.bot/gateway/configuration\#agents-defaults-workspace)  `agents.defaults.workspace`
...
### [​](https://docs.molt.bot/gateway/configuration\#agents-defaults-reporoot)  `agents.defaults.repoRoot`
...
### [​](https://docs.molt.bot/gateway/configuration\#agents-defaults-skipbootstrap)  `agents.defaults.skipBootstrap`
...
### [​](https://docs.molt.bot/gateway/configuration\#agents-defaults-bootstrapmaxchars)  `agents.defaults.bootstrapMaxChars`

Max characters of each workspace bootstrap file injected into the system prompt
before truncation. Default: `20000`.When a file exceeds this limit, Moltbot logs a warning and injects a truncated
...
### [​](https://docs.molt.bot/gateway/configuration\#agents-defaults-usertimezone)  `agents.defaults.userTimezone`
...
### [​](https://docs.molt.bot/gateway/configuration\#agents-defaults-timeformat)  `agents.defaults.timeFormat`
...
### [​](https://docs.molt.bot/gateway/configuration\#messages)  `messages`

Controls inbound/outbound prefixes and optional ack reactions.
See [Messages](https://docs.molt.bot/concepts/messages) for queueing, sessions, and streaming context.
...
#### [​](https://docs.molt.bot/gateway/configuration\#template-variables)  Template variables
...
#### [​](https://docs.molt.bot/gateway/configuration\#messages-tts)  `messages.tts`
...
### [​](https://docs.molt.bot/gateway/configuration\#talk)  `talk`
...
### [​](https://docs.molt.bot/gateway/configuration\#agents-defaults)  `agents.defaults`
...
#### [​](https://docs.molt.bot/gateway/configuration\#agents-defaults-clibackends-cli-fallback)  `agents.defaults.cliBackends` (CLI fallback)
...
#### [​](https://docs.molt.bot/gateway/configuration\#agents-defaults-contextpruning-tool-result-pruning)  `agents.defaults.contextPruning` (tool-result pruning)
...
See [/concepts/session-pruning](https://docs.molt.bot/concepts/session-pruning) for behavior details.

#### [​](https://docs.molt.bot/gateway/configuration\#agents-defaults-compaction-reserve-headroom-+-memory-flush)  `agents.defaults.compaction` (reserve headroom + memory flush)

`agents.defaults.compaction.mode` selects the compaction summarization strategy. Defaults to `default`; set `safeguard` to enable chunked summarization for very long histories. See [/concepts/compaction](https://docs.molt.bot/concepts/compaction).`agents.defaults.compaction.reserveTokensFloor` enforces a minimum `reserveTokens`
...
See [/concepts/streaming](https://docs.molt.bot/concepts/streaming) for behavior + chunking details.Typing indicators:
...
See [/concepts/typing-indicators](https://docs.molt.bot/concepts/typing-indicators) for behavior details.
...
### [​](https://docs.molt.bot/gateway/configuration\#agents-defaults-sandbox)  `agents.defaults.sandbox`

Optional **Docker sandboxing** for the embedded agent. Intended for non-main
sessions so they cannot access your host system.Details: [Sandboxing](https://docs.molt.bot/gateway/sandboxing)Defaults (if enabled):
...
- tool policy: allow only `exec`, `process`, `read`, `write`, `edit`, `apply_patch`, `sessions_list`, `sessions_history`, `sessions_send`, `sessions_spawn`, `session_status` (deny wins)
  ...
  - tool group shorthands supported in sandbox policy: `group:runtime`, `group:fs`, `group:sessions`, `group:memory` (see [Sandbox vs Tool Policy vs Elevated](https://docs.molt.bot/gateway/sandbox-vs-tool-policy-vs-elevated#tool-groups-shorthands))
...
### [​](https://docs.molt.bot/gateway/configuration\#models-custom-providers-+-base-urls)  `models` (custom providers + base URLs)
...
Provider-by-provider overview + examples: [/concepts/model-providers](https://docs.molt.bot/concepts/model-providers).When `models.providers` is present, Moltbot writes/merges a `models.json` into
...
### [​](https://docs.molt.bot/gateway/configuration\#opencode-zen-multi-model-proxy)  OpenCode Zen (multi-model proxy)
...
### [​](https://docs.molt.bot/gateway/configuration\#z-ai-glm-4-7-%E2%80%94-provider-alias-support)  Z.AI (GLM-4.7) — provider alias support

Z.AI models are available via the built-in `zai` provider. Set `ZAI_API_KEY`
in your environment and reference the model by provider/model.Shortcut: `moltbot onboard --auth-choice zai-api-key`.
...
### [​](https://docs.molt.bot/gateway/configuration\#moonshot-ai-kimi)  Moonshot AI (Kimi)
...
### [​](https://docs.molt.bot/gateway/configuration\#kimi-code)  Kimi Code
...
### [​](https://docs.molt.bot/gateway/configuration\#synthetic-anthropic-compatible)  Synthetic (Anthropic-compatible)
...
### [​](https://docs.molt.bot/gateway/configuration\#local-models-lm-studio-%E2%80%94-recommended-setup)  Local models (LM Studio) — recommended setup

See [/gateway/local-models](https://docs.molt.bot/gateway/local-models) for the current local guidance. TL;DR: run MiniMax M2.1 via LM Studio Responses API on serious hardware; keep hosted models merged for fallback.

### [​](https://docs.molt.bot/gateway/configuration\#minimax-m2-1)  MiniMax M2.1
...
### [​](https://docs.molt.bot/gateway/configuration\#cerebras-glm-4-6-/-4-7)  Cerebras (GLM 4.6 / 4.7)
...
### [​](https://docs.molt.bot/gateway/configuration\#session)  `session`
...
### [​](https://docs.molt.bot/gateway/configuration\#skills-skills-config)  `skills` (skills config)
...
### [​](https://docs.molt.bot/gateway/configuration\#plugins-extensions)  `plugins` (extensions)
...
See [/plugin](https://docs.molt.bot/plugin) for full usage.Fields:
...
### [​](https://docs.molt.bot/gateway/configuration\#browser-clawd-managed-browser)  `browser` (clawd-managed browser)
...
### [​](https://docs.molt.bot/gateway/configuration\#ui-appearance)  `ui` (Appearance)
...
### [​](https://docs.molt.bot/gateway/configuration\#gateway-gateway-server-mode-+-bind)  `gateway` (Gateway server mode + bind)
...
- [Web overview](https://docs.molt.bot/web)
...
### [​](https://docs.molt.bot/gateway/configuration\#gateway-reload-config-hot-reload)  `gateway.reload` (Config hot reload)
...
#### [​](https://docs.molt.bot/gateway/configuration\#hot-reload-matrix-files-+-impact)  Hot reload matrix (files + impact)
...
### [​](https://docs.molt.bot/gateway/configuration\#multi-instance-isolation)  Multi-instance isolation
...
See [Gateway runbook](https://docs.molt.bot/gateway) for the derived port mapping (gateway/browser/canvas).
See [Multiple gateways](https://docs.molt.bot/gateway/multiple-gateways) for browser/CDP port isolation details.Example:
...
### [​](https://docs.molt.bot/gateway/configuration\#hooks-gateway-webhooks)  `hooks` (Gateway webhooks)
...
### [​](https://docs.molt.bot/gateway/configuration\#canvashost-lan/tailnet-canvas-file-server-+-live-reload)  `canvasHost` (LAN/tailnet Canvas file server + live reload)
...
### [​](https://docs.molt.bot/gateway/configuration\#bridge-legacy-tcp-bridge,-removed)  `bridge` (legacy TCP bridge, removed)
...
### [​](https://docs.molt.bot/gateway/configuration\#discovery-mdns-bonjour-/-mdns-broadcast-mode)  `discovery.mdns` (Bonjour / mDNS broadcast mode)
...
### [​](https://docs.molt.bot/gateway/configuration\#discovery-widearea-wide-area-bonjour-/-unicast-dns%E2%80%91sd)  `discovery.wideArea` (Wide-Area Bonjour / unicast DNS‑SD)
...
## [​](https://docs.molt.bot/gateway/configuration\#template-variables-2)  Template variables
...
## [​](https://docs.molt.bot/gateway/configuration\#cron-gateway-scheduler)  Cron (Gateway scheduler)

Cron is a Gateway-owned scheduler for wakeups and scheduled jobs. See [Cron jobs](https://docs.molt.bot/automation/cron-jobs) for the feature overview and CLI examples.
...
_Next: [Agent Runtime](https://docs.molt.bot/concepts/agent)_ 🦞

[Environment](https://docs.molt.bot/environment) [Multiple gateways](https://docs.molt.bot/gateway/multiple-gateways)
