---
source: https://docs.molt.bot/reference/RELEASING
title: RELEASING - Moltbot
---

[Skip to main content](https://docs.molt.bot/reference/RELEASING#content-area)
...
- [Release Checklist (npm + macOS)](https://docs.molt.bot/reference/RELEASING#release-checklist-npm-%2B-macos)
- [Operator trigger](https://docs.molt.bot/reference/RELEASING#operator-trigger)
- [Troubleshooting (notes from 2.0.0-beta2 release)](https://docs.molt.bot/reference/RELEASING#troubleshooting-notes-from-2-0-0-beta2-release)
- [Plugin publish scope (npm)](https://docs.molt.bot/reference/RELEASING#plugin-publish-scope-npm)

# [​](https://docs.molt.bot/reference/RELEASING\#release-checklist-npm-+-macos)  Release Checklist (npm + macOS)

Use `pnpm` (Node 22+) from the repo root. Keep the working tree clean before tagging/publishing.

## [​](https://docs.molt.bot/reference/RELEASING\#operator-trigger)  Operator trigger
...
- [ ]  Follow [macOS release](https://docs.molt.bot/platforms/mac/release) for the exact commands and required env vars.

  - `APP_BUILD` must be numeric + monotonic (no `-beta`) so Sparkle compares versions correctly.
  - If notarizing, use the `moltbot-notary` keychain profile created from App Store Connect API env vars (see [macOS release](https://docs.molt.bot/platforms/mac/release)).
...
### [​](https://docs.molt.bot/reference/RELEASING\#troubleshooting-notes-from-2-0-0-beta2-release)  Troubleshooting (notes from 2.0.0-beta2 release)
...
## [​](https://docs.molt.bot/reference/RELEASING\#plugin-publish-scope-npm)  Plugin publish scope (npm)
...
[Test](https://docs.molt.bot/reference/test) [AGENTS.default](https://docs.molt.bot/reference/AGENTS.default)
