---
source: https://docs.molt.bot/automation/gmail-pubsub
title: Gmail pubsub - Moltbot
---

[Skip to main content](https://docs.molt.bot/automation/gmail-pubsub#content-area)
...
- [Gmail Pub/Sub -> Moltbot](https://docs.molt.bot/automation/gmail-pubsub#gmail-pub%2Fsub-%3E-moltbot)
- [Prereqs](https://docs.molt.bot/automation/gmail-pubsub#prereqs)
- [Wizard (recommended)](https://docs.molt.bot/automation/gmail-pubsub#wizard-recommended)
- [One-time setup](https://docs.molt.bot/automation/gmail-pubsub#one-time-setup)
- [Start the watch](https://docs.molt.bot/automation/gmail-pubsub#start-the-watch)
- [Run the push handler](https://docs.molt.bot/automation/gmail-pubsub#run-the-push-handler)
- [Expose the handler (advanced, unsupported)](https://docs.molt.bot/automation/gmail-pubsub#expose-the-handler-advanced%2C-unsupported)
- [Test](https://docs.molt.bot/automation/gmail-pubsub#test)
- [Troubleshooting](https://docs.molt.bot/automation/gmail-pubsub#troubleshooting)
- [Cleanup](https://docs.molt.bot/automation/gmail-pubsub#cleanup)

# [​](https://docs.molt.bot/automation/gmail-pubsub\#gmail-pub/sub-%3E-moltbot)  Gmail Pub/Sub -> Moltbot

Goal: Gmail watch -> Pub/Sub push -> `gog gmail watch serve` -\> Moltbot webhook.

## [​](https://docs.molt.bot/automation/gmail-pubsub\#prereqs)  Prereqs

- `gcloud` installed and logged in ( [install guide](https://docs.cloud.google.com/sdk/docs/install-sdk)).
- `gog` (gogcli) installed and authorized for the Gmail account ( [gogcli.sh](https://gogcli.sh/)).
- Moltbot hooks enabled (see [Webhooks](https://docs.molt.bot/automation/webhook)).
...
under `hooks.transformsDir` (see [Webhooks](https://docs.molt.bot/automation/webhook)).

## [​](https://docs.molt.bot/automation/gmail-pubsub\#wizard-recommended)  Wizard (recommended)
...
## [​](https://docs.molt.bot/automation/gmail-pubsub\#one-time-setup)  One-time setup
...
## [​](https://docs.molt.bot/automation/gmail-pubsub\#start-the-watch)  Start the watch
...
## [​](https://docs.molt.bot/automation/gmail-pubsub\#run-the-push-handler)  Run the push handler
...
## [​](https://docs.molt.bot/automation/gmail-pubsub\#expose-the-handler-advanced,-unsupported)  Expose the handler (advanced, unsupported)
...
## [​](https://docs.molt.bot/automation/gmail-pubsub\#test)  Test
...
## [​](https://docs.molt.bot/automation/gmail-pubsub\#troubleshooting)  Troubleshooting
...
## [​](https://docs.molt.bot/automation/gmail-pubsub\#cleanup)  Cleanup
...
[Webhook](https://docs.molt.bot/automation/webhook) [Cron jobs](https://docs.molt.bot/automation/cron-jobs)
